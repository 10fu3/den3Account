...
create table account_repository(uuid VARCHAR(255) PRIMARY KEY,mail VARCHAR(255),pass VARCHAR(255),nick VARCHAR(255),icon VARCHAR(255),last_login_time VARCHAR(255),admin VARCHAR(255));
